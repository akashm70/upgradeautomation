...
def show_lldp_neighbors():
    try:
        ...
        print(f"Total lldp neighbors: {total_neighbors}")
...
#     folder_path = "output/cisco/"
#     show_inventory()
#     show_install_active_summary(folder_path)
#     show_platform(folder_path)
#     show_install_committed_summary(folder_path)
#     show_hw_module_fpd(folder_path)
#     show_media(folder_path)
#     show_route_summary(folder_path)
#     show_watchdog_memory_state(folder_path)
